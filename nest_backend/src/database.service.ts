...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit(): Promise<void> {
    ...
    await this.pool.query(`
      ...
      ALTER TABLE users ADD COLUMN IF NOT EXISTS payment_policy VARCHAR(20) NOT NULL DEFAULT 'pay_after';
      ...
      ALTER TABLE orders ADD COLUMN IF NOT EXISTS assigned_to INTEGER REFERENCES delivery_boys(id) ON DELETE SET NULL;
